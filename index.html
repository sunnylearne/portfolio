...
<body id="body" data-spy="scroll" data-target=".header">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="promo-block-divider">
                        ...
                        <p class="promo-block-text">Web &amp; Mobile Developer</p>
                    </div>
                    <ul class="list-inline">
                        ...
                        <li><a href="#" class="social-icons"><i class="icon-social-github"></i></a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-sm-offset-1">
                    <div class="margin-b-60">
                        <p>I am Madubuike Sunday Chukwuebuka, a Software Engineer who is passionate about solving
                            complex problems
                            by Building technological solutions out of business needs. I have 2 years
                            of experience working on web and mobile applications.
                        </p>
                        <p>I can fit into any of the phases of the software development life cycle
                            and I can work both individually or collaboratively.
                        </p>

                        <p>I am also passionate about Photography. My experience in Photography is age-long.
                            Nothing makes me much happier than having good gears with beautiful clients.
                        </p>

                        <p>
                            Cinematography was my first love and the passion to do it professionally is still burning in my heart.
                            For that, I pushed myself to become a video editor.I had lots of projects such as weddings and other ceremonies.
                        </p>

                        <p>I also have a thing to do with music. I mean, i found myself in love with music and it became so dear and precious to
                            me. This made me learn to play the piano and currently i am on my fastest lane to learning violin. I visualise myself with microphone 
                            all the time.
                        </p>

                        <p>
                            i love beautiful things. i love to see that care has gone into something. i love to see how something can be 
                            tranformed into its nice-looking part...
                        </p>
                    </div>
                        ...
                        <div class="row row-space-2 margin-b-4">
                            <div class="col-md-4 md-margin-b-4">
                                <div class="service" data-height="height">
                                    ...
                                    <div class="service-info">
                                        <h3>FRONT-END</h3>
                                        <p class="margin-b-5">...beautiful and responsive interfaces to suit your
                                            business needs... clean and minimalistic design</p>
                                    </div>
                            ...
                            <div class="col-md-4 md-margin-b-4">
                                <div class="service bg-color-base wow zoomIn" data-height="height"
                                    ...
                                    <div class="service-info">
                                        ...
                                        <p class="color-white margin-b-5">...powerful back-end design with security
                                            consciousness</p>
                                    </div>
                                    <a href="#" class="content-wrapper-link"></a>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="service" data-height="height">
                                    ...
                                    <div class="service-info">
                                        <h3>MOBILE</h3>
                                        <p class="margin-b-5">...user-friendly and super fast robust mobile apps to suit
                                            your needs</p>
                                    </div>
                                    <a href="#" class="content-wrapper-link"></a>
                                </div>
                ...
                <div class="col-sm-8 col-sm-offset-1">
                    ...
                    <div class="masonry-grid row row-space-2">
                        ...
                        <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 margin-b-4">
                            ...
                            <div class="work work-popup-trigger">
                                <div class="work-overlay">
                                    <img class="full-width img-responsive" src="img/397x400/01.jpg"
                                        alt="Portfolio Image">
                                </div>
                                <div class="work-popup-overlay">
                                    <div class="work-popup-content">
                                ...
                                <div class="work-popup-overlay">
                                    <div class="work-popup-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="margin-t-10 sm-margin-t-0">
                                                    <p class="margin-b-5"><strong>Project Leader:</strong> Sunday Chukwuebuka</p>
                                                    <p class="margin-b-5"><strong>Designer:</strong> Alisa Keys</p>
                                                    <p class="margin-b-5"><strong>Developer:</strong> Mark Doe</p>
                                                    <p class="margin-b-5"><strong>Customer:</strong> Keenthemes</p>
                                                </div>
    ...
    <footer class="footer">
        <div class="content container">
            <div class="row">
                <div class="col-xs-6">
                    <img class="footer-logo" src="img/logo-dark.png" alt="lenz Logo">
                </div>
                <div class="col-xs-6 text-right sm-text-left">
                    <p class="margin-b-0"><a class="fweight-700" href="http://keenthemes.com/preview/aircv/">sunny lenz</a>
